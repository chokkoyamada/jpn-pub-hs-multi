...
export const simulationScenarios: StudentScenario[] = [
  ...
  },
  {
    ...
    policy: { tieBreak: 'score_then_id' },
    students: [
      { id: 'you', name: 'あなた', score: 74, preferences: [1, 2, 3, 4], economicStatus: 'medium' },
      { id: 'a', name: '受験生A', score: 86, preferences: [1, 2, 3, 4], economicStatus: 'high' },
      { id: 'b', name: '受験生B', score: 81, preferences: [1, 2, 3, 4], economicStatus: 'medium' },
      { id: 'c', name: '受験生C', score: 77, preferences: [2, 1, 3, 4], economicStatus: 'medium' },
      { id: 'd', name: '受験生D', score: 72, preferences: [2, 3, 4, 1], economicStatus: 'low' },
  ...
  },
  {
    ...
    policy: { tieBreak: 'score_then_id' },
    students: [
      { id: 'you', name: 'あなた', score: 69, preferences: [2, 3, 4, 1], economicStatus: 'medium' },
      ...
      { id: 'c', name: '受験生C', score: 74, preferences: [2, 3, 4, 1], economicStatus: 'high' },
      { id: 'd', name: '受験生D', score: 71, preferences: [3, 2, 4, 1], economicStatus: 'medium' },
      { id: 'e', name: '受験生E', score: 66, preferences: [3, 4, 2, 1], economicStatus: 'low' },
      { id: 'f', name: '受験生F', score: 60, preferences: [4, 3, 2, 1], economicStatus: 'medium' },
    ],
    singleChoices: {
      you: 3,
      a: 1,
