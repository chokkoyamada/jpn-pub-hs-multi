...
<p className="mb-4 text-gray-700">
  DAアルゴリズムの最大の特徴は、<strong>公平性</strong>、<strong>安定性</strong>、そして
  <strong>戦略的操作不可能性</strong>
  です。公平性とは、全ての学生が自分の志望と成績に基づいて公正に評価されることを意味します。安定性とは、どの学生も自分より低い順位の学校に入学することがなく、また学校が受け入れた学生よりも高い成績の学生がいる場合、その学生はその学校を希望していないことを意味します。つまり、成績の良い学生がある学校を希望しない場合、その学校は成績が比較的低い学生でも受け入れることがあります。戦略的操作不可能性とは、学生が自分の本当の志望順位を正直に申告することが最適な戦略となることを意味します。
</p>
