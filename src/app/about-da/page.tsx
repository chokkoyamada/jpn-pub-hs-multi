...
<div className="mb-4 text-slate-700">
  ...
  <ul className="ml-5 space-y-2 list-disc">
    <li>
      <strong>公平性</strong>：全ての学生が志望と成績に基づいて適切に割り振られることです。どの学生も、他の学生のマッチング結果に対して「自分ならもっと良い（優先順位が高い）はず」と主張できるケースが存在しません。
    </li>
    <li>
      <strong>安定性</strong>：マッチング後に、任意の学生と学校の組み合わせが、現行の割り当てに対して両者ともより良いと感じる（ブロッキングペアとなる）状態が存在しないことです。
    </li>
    <li>
      <strong>戦略的操作不可能性</strong>：学生が本当の志望順位を正直に申告することが最適な戦略となることです。
    </li>
  </ul>
</div>
